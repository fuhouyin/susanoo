...
public enum ContrastLevel {
    ...
    public static double getContrastRatioOpacityAware(Color bgColor, Color fgColor, Color bgBaseColor) {
        double luminance1 = getColorLuminance(JColorUtils.flattenColor(bgBaseColor, bgColor));
        double luminance2 = getColorLuminance(JColorUtils.flattenColor(bgBaseColor, fgColor));
